...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Estimate: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.EstimateFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.EstimateAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "updatedAt" | "name" | "email" | "image", ExtArgs["result"]["user"]>
  ...
  export type EstimateOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "updatedAt" | "title" | "table" | "content", ExtArgs["result"]["estimate"]>
  ...
  export interface EstimateDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Estimates that matches the filter.
     * @param {EstimateFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const estimate = await prisma.estimate.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: EstimateFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Estimate.
     * @param {EstimateAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const estimate = await prisma.estimate.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: EstimateAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface EstimateFieldRefs {
    ...
    readonly table: FieldRef<"Estimate", 'String'>
    readonly content: FieldRef<"Estimate", 'Json'>
  }
   ...
   * Estimate findRaw
   */
  export type EstimateFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Estimate aggregateRaw
   */
  export type EstimateAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type EstimateWhereInput = {
    ...
    title?: StringNullableFilter<"Estimate"> | string | null
    table?: StringNullableFilter<"Estimate"> | string | null
    content?: JsonNullableFilter<"Estimate">
  }
  ...
  export type EstimateScalarWhereWithAggregatesInput = {
    ...
    title?: StringNullableWithAggregatesFilter<"Estimate"> | string | null
    table?: StringNullableWithAggregatesFilter<"Estimate"> | string | null
    content?: JsonNullableWithAggregatesFilter<"Estimate">
  }
